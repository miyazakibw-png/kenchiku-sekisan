...
export default function RoomSheetPage({
  ...
  const ceilingLines = useMemo(() => {
    ...
    // 高さが違う区画の境目は実線、高さがまだ決まっていない境目は点線、
