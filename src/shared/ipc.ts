export const IPC = {
  ...
  miscSheetCopyFromProject: "miscSheet:copyFromProject",
  miscSheetListSave: "miscSheet:listSave",
  miscSheetGet: "miscSheet:get",
  miscSheetSave: "miscSheet:save",
  furnitureSheetList: "furnitureSheet:list",
  furnitureSheetCreate: "furnitureSheet:create",
  furnitureSheetDelete: "furnitureSheet:delete",
  furnitureSheetPaste: "furnitureSheet:paste",
  furnitureSheetCopyFromProject: "furnitureSheet:copyFromProject",
  ...
  lineStylesGet: "settings:lineStylesGet",
  lineStylesSave: "settings:lineStylesSave",
